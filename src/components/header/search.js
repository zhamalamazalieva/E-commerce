const Search = () => {
    ...
    <div class="searchbar__inner">
        ...
        <span class="dropdown__button">All categories</span>
        <ul class="dropdowm__list">
            <li class="dropdown__item" >Drinks</li>
            <li class="dropdown__item" >Bakery</li>
            <li class="dropdown__item" >Pharmacy</li>
            <li class="dropdown__item" >Meat and fish</li>
        </ul>
        </div>
        <form>
