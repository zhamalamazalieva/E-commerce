const HeroItemRight = () => {
    ...
    heroItem.className = 'hero__wrapper row';
    heroItem.innerHTML =
    `
    <div class="col-6">
        <div class="hero__item hero__item--right">
            <img class="hero__img" src="./src/img/jpg/images.jpg" alt="photo">
                <div class="hero__text">
                <span class="hero__suptitle">Banner subfocus</span>
                <h2 class="hero__title">Space for heading</h2>
                <button class="hero__button--recipe btn btn--green">Read recepies
